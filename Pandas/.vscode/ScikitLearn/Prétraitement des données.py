...
print("############################################# " )                    #et les autres valeurs inférieurs a 0.5 seront convertis en 0
...
print("La variances des données : \n",data_normalized.std(axis=0),"\n")
...
iris = load_iris()
dtfrm = pd.DataFrame(data=iris.data, columns=iris.feature_names)
print("Les donnes du dataframe de Iris:\n\n",dtfrm.head())